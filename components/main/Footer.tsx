      ...
      <div className="w-full flex flex-col justify-center items-center m-auto">
        <div className="w-full h-full flex flex-row items-center justify-around flex-wrap">
          <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
            <div className="w-full text-[16px]">Community</div>
          ...
          <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
            <div className="w-full text-[16px]">Social Media</div>
            <p className="flex flex-row items-center my-[15px] cursor-pointer">
              <RxInstagramLogo />
          ...
          <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
            <div className="w-full text-[16px]">About</div>
            <p className="flex flex-row items-center my-[15px] cursor-pointer">
            ...
            <p className="flex flex-row items-center my-[15px] cursor-pointer">
              <span className="ml-[6px]">saddamhossaindev@gmail.com</span>
            </p>
          </div>
        </div>
